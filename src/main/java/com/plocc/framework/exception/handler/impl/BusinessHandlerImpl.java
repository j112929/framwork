...
import com.plocc.framework.exception.BusinessException;
 ...
 * 
 */
public class BusinessHandlerImpl extends AbstractHandlerImpl {

	@Override
	public ModelAndView doHandler(HttpServletRequest request,
			HttpServletResponse response, ModelAndView modelAndView,
			Map<String, Object> params) {
		BusinessException ex = (BusinessException) params
